...
public class CompraController {
    ...
    public ResponseEntity<CompraPagoUnicoResponse> crearCompraPagoUnico(
        ...
        if (request.codigosPromociones() != null && !request.codigosPromociones().isEmpty()) {
            promociones = request.codigosPromociones().stream()
                    .map(promocionService::obtenerPromocionPorCodigo)
                    .collect(Collectors.toList());
        }

        CompraPagoUnico compra = CompraMapper.toEntity(request, tarjeta, promociones);
    ...
    public ResponseEntity<CompraCuotasResponse> crearCompraCuotas(
        ...
        CompraCuotas compra = CompraMapper.toEntity(request, tarjeta, promociones);
